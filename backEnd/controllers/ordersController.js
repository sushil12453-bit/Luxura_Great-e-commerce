...
//creating the instance of stripe using the secret key
const stripe = new Stripe(process.env.STRIPE_SECRET_KEY, {
  apiVersion: "16-10-2023",
});
...
//Verify Stripe Todo:- Make i secure using webhooks 
...
//placing using Razorpay method Todo: i will add it later
